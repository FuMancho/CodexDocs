...
This is a **documentation-only** repository for OpenAI Codex CLI. It contains curated, community-maintained documentation files in `docs/`.
...
- **Official sources only:** Content must be sourced from developers.openai.com
