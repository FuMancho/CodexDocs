...
basics](/codex/config-basic#configuration-precedence "/codex/config-basic#configuration-precedence") for more information.
...
and Stable. See [Feature Maturity](/codex/feature-maturity "/codex/feature-maturity") for how to
interpret these labels.

| Key | Maturity | Details |
| --- | --- | --- |
| [`codex`](/codex/cli/reference#codex-interactive "/codex/cli/reference#codex-interactive") | Stable | Launch the terminal UI. Accepts the global flags above plus an optional prompt or image attachments. |
| [`codex app`](/codex/cli/reference#codex-app "/codex/cli/reference#codex-app") | Stable | Launch the Codex desktop app on macOS or Windows. On macOS, Codex can open a workspace path; on Windows, Codex prints the path to open. |
| [`codex app-server`](/codex/cli/reference#codex-app-server "/codex/cli/reference#codex-app-server") | Experimental | Launch the Codex app server for local development or debugging over stdio, WebSocket, or a Unix socket. |
| [`codex apply`](/codex/cli/reference#codex-apply "/codex/cli/reference#codex-apply") | Stable | Apply the latest diff generated by a Codex Cloud task to your local working tree. Alias: `codex a`. |
| [`codex cloud`](/codex/cli/reference#codex-cloud "/codex/cli/reference#codex-cloud") | Experimental | Browse or execute Codex Cloud tasks from the terminal without opening the TUI. Alias: `codex cloud-tasks`. |
| [`codex completion`](/codex/cli/reference#codex-completion "/codex/cli/reference#codex-completion") | Stable | Generate shell completion scripts for Bash, Zsh, Fish, or PowerShell. |
| [`codex debug app-server send-message-v2`](/codex/cli/reference#codex-debug-app-server-send-message-v2 "/codex/cli/reference#codex-debug-app-server-send-message-v2") | Experimental | Debug app-server by sending a single V2 message through the built-in test client. |
| [`codex debug models`](/codex/cli/reference#codex-debug-models "/codex/cli/reference#codex-debug-models") | Experimental | Print the raw model catalog Codex sees, including an option to inspect only the bundled catalog. |
| [`codex exec`](/codex/cli/reference#codex-exec "/codex/cli/reference#codex-exec") | Stable | Run Codex non-interactively. Alias: `codex e`. Stream results to stdout or JSONL and optionally resume previous sessions. |
| [`codex execpolicy`](/codex/cli/reference#codex-execpolicy "/codex/cli/reference#codex-execpolicy") | Experimental | Evaluate execpolicy rule files and see whether a command would be allowed, prompted, or blocked. |
| [`codex features`](/codex/cli/reference#codex-features "/codex/cli/reference#codex-features") | Stable | List feature flags and persistently enable or disable them in `config.toml`. |
| [`codex fork`](/codex/cli/reference#codex-fork "/codex/cli/reference#codex-fork") | Stable | Fork a previous interactive session into a new thread, preserving the original transcript. |
| [`codex login`](/codex/cli/reference#codex-login "/codex/cli/reference#codex-login") | Stable | Authenticate Codex using ChatGPT OAuth, device auth, an API key, or an access token piped over stdin. |
| [`codex logout`](/codex/cli/reference#codex-logout "/codex/cli/reference#codex-logout") | Stable | Remove stored authentication credentials. |
| [`codex mcp`](/codex/cli/reference#codex-mcp "/codex/cli/reference#codex-mcp") | Experimental | Manage Model Context Protocol servers (list, add, remove, authenticate). |
| [`codex mcp-server`](/codex/cli/reference#codex-mcp-server "/codex/cli/reference#codex-mcp-server") | Experimental | Run Codex itself as an MCP server over stdio. Useful when another agent consumes Codex. |
| [`codex plugin marketplace`](/codex/cli/reference#codex-plugin-marketplace "/codex/cli/reference#codex-plugin-marketplace") | Experimental | Add, list, upgrade, or remove plugin marketplaces from Git or local sources. |
| [`codex remote-control`](/codex/cli/reference#codex-remote-control "/codex/cli/reference#codex-remote-control") | Experimental | Ensure the local app-server daemon is running with remote-control support enabled. |
| [`codex resume`](/codex/cli/reference#codex-resume "/codex/cli/reference#codex-resume") | Stable | Continue a previous interactive session by ID or resume the most recent conversation. |
| [`codex sandbox`](/codex/cli/reference#codex-sandbox "/codex/cli/reference#codex-sandbox") | Experimental | Run arbitrary commands inside Codex-provided macOS, Linux, or Windows sandboxes. |
| [`codex update`](/codex/cli/reference#codex-update "/codex/cli/reference#codex-update") | Stable | Check for and apply a Codex CLI update when the installed release supports self-update. |

Key

[`codex`](/codex/cli/reference#codex-interactive "/codex/cli/reference#codex-interactive")
...
[`codex app`](/codex/cli/reference#codex-app "/codex/cli/reference#codex-app")
...
[`codex app-server`](/codex/cli/reference#codex-app-server "/codex/cli/reference#codex-app-server")
...
[`codex apply`](/codex/cli/reference#codex-apply "/codex/cli/reference#codex-apply")
...
[`codex cloud`](/codex/cli/reference#codex-cloud "/codex/cli/reference#codex-cloud")
...
[`codex completion`](/codex/cli/reference#codex-completion "/codex/cli/reference#codex-completion")
...
[`codex debug app-server send-message-v2`](/codex/cli/reference#codex-debug-app-server-send-message-v2 "/codex/cli/reference#codex-debug-app-server-send-message-v2")
...
[`codex debug models`](/codex/cli/reference#codex-debug-models "/codex/cli/reference#codex-debug-models")
...
[`codex exec`](/codex/cli/reference#codex-exec "/codex/cli/reference#codex-exec")
...
[`codex execpolicy`](/codex/cli/reference#codex-execpolicy "/codex/cli/reference#codex-execpolicy")
...
[`codex features`](/codex/cli/reference#codex-features "/codex/cli/reference#codex-features")
...
[`codex fork`](/codex/cli/reference#codex-fork "/codex/cli/reference#codex-fork")
...
[`codex login`](/codex/cli/reference#codex-login "/codex/cli/reference#codex-login")
...
[`codex logout`](/codex/cli/reference#codex-logout "/codex/cli/reference#codex-logout")
...
[`codex mcp`](/codex/cli/reference#codex-mcp "/codex/cli/reference#codex-mcp")
...
[`codex mcp-server`](/codex/cli/reference#codex-mcp-server "/codex/cli/reference#codex-mcp-server")
...
[`codex plugin marketplace`](/codex/cli/reference#codex-plugin-marketplace "/codex/cli/reference#codex-plugin-marketplace")
...
[`codex remote-control`](/codex/cli/reference#codex-remote-control "/codex/cli/reference#codex-remote-control")
...
[`codex resume`](/codex/cli/reference#codex-resume "/codex/cli/reference#codex-resume")
...
[`codex sandbox`](/codex/cli/reference#codex-sandbox "/codex/cli/reference#codex-sandbox")
...
[`codex update`](/codex/cli/reference#codex-update "/codex/cli/reference#codex-update")
...
* [Codex CLI overview](/codex/cli "/codex/cli"): installation, upgrades, and quick tips.
* [Config basics](/codex/config-basic "/codex/config-basic"): persist defaults like the model and provider.
* [Advanced Config](/codex/config-advanced "/codex/config-advanced"): profiles, providers, sandbox tuning, and integrations.
* [AGENTS.md](/codex/guides/agents-md "/codex/guides/agents-md"): conceptual overview of Codex agent capabilities and best practices.
